...
//		
//		Mockito.when(secretariaRepository.findByAreaAtuacao(AreaAtuacao.SAUDE).thenReturn(false));
//		
...
//		CriaSecretariaDTO secretariaDto = criaSecretariaDTO();
//
//		Mockito.when(secretariaRepository.findByAreaAtuacao(AreaAtuacao.SAUDE).thenReturn(true));
//
//		MensagemDTO mensagemRetornada = this.secretariaService.adicionaSecretaria(secretariaDto);
//		MensagemDTO mensagemEsperada = new MensagemDTO(CADASTRO_REALIZADO_COM_SUCESSO);
//
...
//		
//		Mockito.when(secretariaRepository.findById(1L).thenReturn(true));
//		
...
//		
//		Mockito.when(secretariaRepository.findById(1L).thenReturn(false));
//		
//		MensagemDTO mensagemRetornada = this.secretariaService.removeSecretaria(1L);
//		MensagemDTO mensagemEsperada = new MensagemDTO (SECRETARIA_INEXISTENTE);
//		
//		Assert.assertEquals("Deve retornar mensagem insucesso na remoção da secretaria", mensagemEsperada, mensagemRetornada);
//	}
//	
//
